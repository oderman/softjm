				...
				<div class="span12">
					<div class="content-widgets light-gray">
						...
						<div class="widget-container">
							...
							<tbody>
                            <?php
							$consulta = mysql_query("SELECT * FROM zonas",$conexion);
							$no = 1;
							...
							<tr>
                                ...
                                <td><h4>
                                    ...
                                    <a href="sql.php?id=<?=$res[0];?>&get=14" onClick="if(!confirm('Desea eliminar el registro?')){return false;}" data-toggle="tooltip" title="Eliminar"><i class="icon-remove-sign"></i></a>
                                </h4></td>
							</tr>
                            <?php $no++;}?>
							</tbody>
