...
<?php
$idPagina = 9;
$paginaActual['pag_nombre'] = "Acciones";
?>
				...
				<div class="span12">
					<div class="content-widgets light-gray">
						...
						<div class="widget-container">
							...
							<tbody>
                            <?php
							$consulta = mysql_query("SELECT * FROM clientes WHERE cli_ocultar=1",$conexion);
							$no = 1;
							...
							<tr>
                                ...
                                <td><h4>
                                	<a href="sql.php?id=<?=$res[0];?>&get=10"><i class="icon-eye-open"></i></a>
                                </h4></td>
							</tr>
                            <?php $no++;}?>
							</tbody>
