...
if(empty($_POST["notfCliente"])){$_POST["notfCliente"]=0;}

$archivo = "";
if(!empty($_FILES['archivo']['name'])){
	$extensionParte1 = explode(".", $_FILES['archivo']['name']);
...
echo '<script type="text/javascript">window.location.href="../remisiones-seguimiento.php?id='.$_POST["id"].'";</script>';
exit();