...
<?php
$idPagina = 32;
$paginaActual['pag_nombre'] = "Editar Momento";
?>
...
?>
<?php
$resultadoD = mysql_fetch_array(mysql_query("SELECT * FROM momentos WHERE mom_id='".$_GET["id"]."'",$conexion));
?>
<!-- styles -->
			...
			<div class="row-fluid ">
				<div class="span12">
					...
					<ul class="breadcrumb">
                        ...
                        <li><a href="clientes-momentos.php?cte=<?=$_GET["cte"];?>">Momentos</a><span class="divider"><i class="icon-angle-right"></i></span></li>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="16">
                            ...
                            <input type="hidden" name="cte" value="<?=$_GET["cte"];?>">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span4" name="nombre" value="<?=$resultadoD[2];?>">
									</div>
								</div>
