				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="14">
                            <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                ...
                                <div class="control-group">
                                   ...
                                   <i class="icon-file"></i> <a href="files/documentos/<?=$resultadoD['doc_documento'];?>" target="_blank"><?=$resultadoD['doc_documento'];?></a>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span8" tabindex="2" name="cliente">
											...
											?>
                                            	<option value="<?=$resOp[0];?>" <?php if($resultadoD['doc_cliente']==$resOp[0]){echo "selected";}?>><?=$resOp[1];?></option>
                                            <?php
											}
											?>
                                    	</select>
