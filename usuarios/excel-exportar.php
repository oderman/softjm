...
<body>
	...
	if (isset($_GET["exp"]) and $_GET["exp"] == 1) {
		...
		INNER JOIN localidad_departamentos ON dep_id=ciu_departamento AND dep_id='" . $_GET["dpto"] . "'", $conexion);
		} else {
			$consulta = $consulta = mysql_query("SELECT * FROM clientes
		INNER JOIN localidad_ciudades ON ciu_id=cli_ciudad
		INNER JOIN localidad_departamentos ON dep_id=ciu_departamento", $conexion);
		}
	?>
		<div align="center">
