...
<?php
$idPagina = 34;
$paginaActual['pag_nombre'] = "Agegar grupos";
?>
			...
			<div class="row-fluid ">
				<div class="span12">
					...
					<ul class="breadcrumb">
						...
						<li><a href="clientes.php">Grupos</a><span class="divider"><i class="icon-angle-right"></i></span></li>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="17">
