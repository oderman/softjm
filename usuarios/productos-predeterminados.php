...
<?php
$idPagina = 121;
$paginaActual['pag_nombre'] = "Productos con precio prededeterminado";
?>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="68">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span12" multiple tabindex="2" name="producto[]">
											...
											while($resOp = mysql_fetch_array($conOp)){
												$numD = mysql_num_rows(mysql_query("SELECT * FROM productos WHERE prod_precio_predeterminado=1 AND prod_id='".$resOp[0]."'",$conexion));
											?>
