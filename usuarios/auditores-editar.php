				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="10">
                            <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                            	
                                <div class="control-group">
									<label class="control-label">Nombre</label>
									<div class="controls">
										<input type="text" class="span4" name="nombre" value="<?=$resultadoD[1];?>">
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2" name="especialidad">
											<option value=""></option>
                                            <option value="1" <?php if($resultadoD[2]==1) echo "selected";?>>Especialidad 1</option>
                                            <option value="2" <?php if($resultadoD[2]==2) echo "selected";?>>Especialidad 2</option>
                                    	</select>
                                    </div>
                               </div>
