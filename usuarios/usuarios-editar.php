    ...
    <div class="main-wrapper">
      <div class="container-fluid">
        ...
        <p>
          ...
          <a href="usuarios-editar-zonas.php?id=<?=$_GET["id"];?>" class="btn btn-info"><i class="icon-edit"></i> Editar
            zonas</a>
          ...
          <div class="span8">
            ...
            <div class="content-widgets gray">
              ...
              <div class="widget-container">
                ...
                <form class="form-horizontal" method="post" action="bd_update/actualizar-usuarios.php"
        ...
        ?>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2"
                        name="tipoU">
                        <option value=""></option>
                        <?php
                    ...
                    <div class="controls">
                      <select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2"
                        ...
                        <?php
											...
											while($resOp = mysqli_fetch_array($conOp, MYSQLI_BOTH)){
											?>
                        <option value="<?=$resOp[0];?>"
                          <?php if($resultadoD['usr_sucursal']==$resOp[0]) echo "selected";?>><?=$resOp[1];?></option>
                        <?php
											}
											?>
                      </select>
                    ...
                    <div class="controls">
                      <select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2"
                        ...
                        <?php
											...
											while($resOp = mysqli_fetch_array($conOp, MYSQLI_BOTH)){
											?>
                        <option value="<?=$resOp[0];?>" <?php if($resultadoD['usr_area']==$resOp[0]) echo "selected";?>>
                          <?=$resOp[1];?></option>
                        <?php
											}
											?>
                    ...
                    <div class="controls">
                      <select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2"
                        ...
                        <?php
											...
											while($resOp = mysqli_fetch_array($conOp, MYSQLI_BOTH)){
											?>
                        <option value="<?=$resOp['ciu_id'];?>"
                          <?php if($resultadoD['usr_ciudad']==$resOp['ciu_id']){echo "selected";}?>>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" class="span2" name="fallidos"
                        value="<?=$resultadoD['usr_intentos_fallidos'];?>">
                    </div>
                  </div>
                  ...
                  <div class="form-actions">
                    <a href="javascript:history.go(-1);" class="btn btn-primary"><i class="icon-arrow-left"></i>
                      Regresar</a>
