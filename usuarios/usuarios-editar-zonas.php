...
<?php
$idPagina = 176;
$paginaActual['pag_nombre'] = "Editar Zonas de usuario";
?>
...
<div class="layout">
	...
	<div class="main-wrapper">
		<div class="container-fluid">
            ...
            <!--<p><a href="usuarios-agregar.php" class="btn btn-danger"><i class="icon-plus"></i> Agregar nuevo</a></p>-->
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2" name="zona[]" multiple>
											...
											while($resOp = mysql_fetch_array($conOp)){
												$numZ = mysql_num_rows(mysql_query("SELECT * FROM zonas_usuarios WHERE zpu_usuario='".$resultadoD['usr_id']."' AND zpu_zona='".$resOp['zon_id']."'",$conexion));
											?>
								...
								<div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción..." class="chzn-select span8" tabindex="2" name="cliente[]" multiple>
											<option value=""></option>
                                            <?php
											$conOp = mysql_query("SELECT cli_id, cli_nombre FROM clientes",$conexion);
											while($resOp = mysql_fetch_array($conOp)){

												$numZ = mysql_num_rows(mysql_query("SELECT cliu_cliente, cliu_usuario FROM clientes_usuarios WHERE cliu_usuario='".$resultadoD['usr_id']."' AND cliu_cliente='".$resOp[0]."'",$conexion));
											?>
