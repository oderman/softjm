...
<?php
$idPagina = 156;
$paginaActual['pag_nombre'] = "Editar servicios";
?>
...
?>
<?php
$resultadoD = mysql_fetch_array(mysql_query("SELECT * FROM servicios WHERE serv_id='".$_GET["id"]."'",$conexion));
?>
<!-- styles -->
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="60">
                            <input type="hidden" name="id" value="<?=$_GET["id"];?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span4" name="precio" value="<?=$resultadoD['serv_precio'];?>">
									</div>
								</div>
