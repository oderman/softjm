								...
								<td>
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="usuarios/bd_update/cliente-estado-mercadeo-update.php?get=42&idR=<?=$res['cli_id'];?>&em=1" name="<?=$res['cli_id'];?>"  title="1" onClick="mercadeo(this)">No contestó. Mantener en la lista.</a></li>
											<li><a href="usuarios/bd_update/cliente-estado-mercadeo-update?get=42&idR=<?=$res['cli_id'];?>&em=7" name="<?=$res['cli_id'];?>" title="7" onClick="mercadeo(this)">No contestó. Quitar de la lista.</a></li>
											<li><a href="usuarios/bd_update/cliente-estado-mercadeo-update?get=42&idR=<?=$res['cli_id'];?>&em=2" name="<?=$res['cli_id'];?>" title="2" onClick="mercadeo(this)">Número equivocado</a></li>
