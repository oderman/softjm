...
$idRemisiones= count($_POST["remisiones"]);
...
$consulta=$conexionBdAdmin->query("SELECT * FROM documentos_configuracion WHERE dconf_id_empresa= '".$idEmpresa."' AND dconf_id_documento='".ID_DOC_REMISION."';");
...
<body style="font-family:<?php echo $configuracionDoc['dconf_estilo_letra'] ?? 'Verdana, sans-serif'; ?>; font-size:<?php echo $configuracionDoc['dconf_tamano_letra'] ?? '11'; ?>px; color: black;">
	...
	<table style="width:90%; height: 120px;" border="0" align="center">
		<tr>
			<td><img src="../files/images/logonuevo.png" width="300"></td>
			<td>
