						...
						<div class="widget-container">
							...
							<tr>
                                ...
                                <td><h4>
                                    ...
                                    <a href="bd_delete/clientes-sucursales-eliminar.php?id=<?=$res[0];?>" onClick="if(!confirm('Desea eliminar el registro?')){return false;}" data-toggle="tooltip" title="Eliminar"><i class="icon-remove-sign"></i></a>
                                </h4></td>
							</tr>
                            <?php $no++;}?>
							</tbody>
