...
<?php
$idPagina = 163;
$paginaActual['pag_nombre'] = "Editar areas";
?>
...
?>
<?php
$resultadoD = mysql_fetch_array(mysql_query("SELECT * FROM areas WHERE ar_id='".$_GET["id"]."'",$conexion));
?>
<!-- styles -->
			...
			<div class="row-fluid ">
				<div class="span12">
					...
					<ul class="breadcrumb">
						...
						<li><a href="areas.php">Areas</a><span class="divider"><i class="icon-angle-right"></i></span></li>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="66">
                            <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                            	   
                                <div class="control-group">
									<label class="control-label">Nombre</label>
									<div class="controls">
										<input type="text" class="span4" name="nombre" value="<?=$resultadoD['ar_nombre'];?>">
									</div>
								</div>
