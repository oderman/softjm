...
<?php
$idPagina = 146;
$paginaActual['pag_nombre'] = "Agregar productos a bodegas";
?>
                        ...
                        <div class="content-widgets gray">
                            ...
                            <div class="widget-container">
                                <form class="form-horizontal" method="post" action="sql.php">
                                    <input type="hidden" name="idSql" value="80">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select data-placeholder="Escoja una opción..." class="chzn-select span8" tabindex="2" name="producto" required>
                                                ...
                                                ?>
                                                    <option value="<?= $resOp[0]; ?>" <?php if($resOp[0] == $_GET["prod"]){echo "selected";} ?> ><?= $resOp[1]; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select data-placeholder="Escoja una opción..." class="chzn-select span8" tabindex="2" name="bodega" required>
                                                ...
                                                while ($resOp = mysql_fetch_array($conOp)) {
                                                ?>
                                                    <option value="<?= $resOp[0]; ?>" <?php if($resOp[0] == $_GET["bod"]){echo "selected";} ?> ><?= $resOp[1]; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span2" name="existencia" value="<?=$_GET["ex"];?>" required>
                                        </div>
                                    </div>
