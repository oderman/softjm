            ...
            <div class="content-widgets gray">
              ...
              <div class="widget-container">
                <form class="form-horizontal" method="post" action="bd_create/usuarios-guardar.php">
                  ...
                  <?php
													$clio_id = 1; // El ID del cliente que deseas recuperar
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <div class="input-prepend">
                        <input type="text" class="span8" name="usuario" required>
                        <input type="text" class="span6" value="<?php echo $dominio; ?>" readonly name="dominio">
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="controls">
                      <select data-placeholder="Escoja una opción..." class="chzn-select span4" tabindex="2"
                        ...
                        <?php
											...
											while($resOp = mysqli_fetch_array($conOp, MYSQLI_BOTH)){
											?>
                        <option value="<?=$resOp['ciu_id'];?>"><?=$resOp['ciu_nombre'].", ".$resOp['dep_nombre'];?>
                        </option>
                        <?php
											}
											?>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <select data-placeholder="Escoja una opción..." class="chzn-select span4" multiple tabindex="2"
                        name="zona[]">
                        <option value=""></option>
                        <?php
