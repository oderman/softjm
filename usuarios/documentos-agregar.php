...
<?php
$idPagina = 24;
$paginaActual['pag_nombre'] = "Agregar documentos";
?>
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="13">
                            <input type="hidden" name="cte" value="<?=$_GET["cte"];?>">
                               ...
                               <div class="control-group">
								...
								<div class="form-actions">
									<button type="submit" class="btn btn-info"><i class="icon-upload"></i> Subir documento</button>
								</div>
							</form>
						</div>
					</div>
