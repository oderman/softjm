				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
							<form class="form-horizontal" method="post" action="bd_create/paginas-guardar.php">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción" class="chzn-select span6" tabindex="4" name="crud">
                                            ...
                                            while($n<=4){
                                            ?>
                                            <option value="<?=$n;?>"><?=$tipoCrud[$n];?></option>
                                            <?php $n++;}?>
										</select>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" name="ruta">
									</div>
								</div>

                                <div class="form-actions">
								<?php if(Modulos::validarRol([75], $conexionBdPrincipal, $conexionBdAdmin, $datosUsuarioActual, $configuracion)){
                                    ?>
