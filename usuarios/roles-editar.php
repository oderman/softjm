...
<?php
$idPagina = 7;
$paginaActual['pag_nombre'] = "Editar Roles";
?>
...
?>
<?php
$resultadoD = mysql_fetch_array(mysql_query("SELECT * FROM usuarios_tipos WHERE utipo_id='".$_GET["id"]."'",$conexion));
?>
<!-- styles -->
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
							<form class="form-horizontal" method="post" action="#sql.php" name="roles" id="roles">
                            ...
                            <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                ...
                                <div class="control-group">
									<label class="control-label">Paginas NO permitidas</label>
									<div class="controls">
										<select data-placeholder="Escoja una opción" class="chzn-select span6" multiple tabindex="4" name="paginasNP[]">
											<option value=""></option>
                                            <?php
											$conOp = mysql_query("SELECT * FROM paginas",$conexion);
											while($resOp = mysql_fetch_array($conOp)){
												$paginasNP = mysql_num_rows(mysql_query("SELECT * FROM paginas_perfiles WHERE pper_pagina='".$resOp[0]."' AND pper_tipo_usuario='".$resultadoD['utipo_id']."'",$conexion));
											?>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<select data-placeholder="Escoja una opción" class="chzn-select span6" multiple tabindex="4" name="paginasP[]">
											<option value=""></option>
                                            <?php
											$conOp = mysql_query("SELECT * FROM ".$bdAdmin.".paginas",$conexion);
											while($resOp = mysql_fetch_array($conOp)){
												$paginasP = mysql_num_rows(mysql_query("SELECT * FROM paginas_perfiles WHERE pper_pagina='".$resOp[0]."' AND pper_tipo_usuario='".$resultadoD['utipo_id']."'",$conexion));
											?>
