...
?>
<?php
$resultadoD = mysql_fetch_array(mysql_query("SELECT * FROM bodegas 
WHERE bod_id='".$_GET["id"]."'",$conexion));
?>
<!-- styles -->
				...
				<div class="span12">
					<div class="content-widgets gray">
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idSql" value="79">
