			...
			<div class="row-fluid ">
				<div class="span12">
					...
					<ul class="breadcrumb">
						...
						<li><a href="zonas.php">Zonas</a><span class="divider"><i class="icon-angle-right"></i></span></li>
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="id" value="<?=$_GET["id"];?>">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" name="nombre" value="<?=$resultadoD['zon_nombre'];?>">
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<textarea rows="5" cols="80" style="width: 80%" class="tinymce-simple" name="observaciones"><?=$resultadoD['zon_observaciones'];?></textarea>
									</div>
								</div>
