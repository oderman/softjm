...
$idPagina = 19;
$tituloPagina = "Solicitar copia de certificado";
						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="idRem" value="<?=$_GET['id'];?>">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" name="nombre" required>
									</div>
								</div>
								
								<div class="control-group">
									<label class="control-label">Su correo para enviar la copia</label>
									<div class="controls">
								...
								<div class="form-actions">
									<button type="submit" class="btn btn-info"><i class="icon-save"></i> Solicitar copia</button>
