						...
						<div class="widget-container">
                            ...
                            <input type="hidden" name="id" value="<?=$resultadoD['cli_id'];?>">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span4" name="usuario" value="<?=$resultadoD['cli_usuario'];?>" required readonly>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span4" name="nombre" value="<?=$resultadoD['cli_nombre'];?>" readonly>
									</div>
								</div>
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="email" class="span4" name="email" value="<?=$resultadoD['cli_email'];?>" readonly>
									</div>
								</div>
