				...
				<div class="span12">
					<div class="content-widgets light-gray">
						...
						<div class="widget-container">
							...
							<a href="historial-equipos-seguimientos-informe.php?id=<?=$_GET["id"];?>" class="btn btn-info" target="_blank"><i class="icon-print"></i> Imprimir</a>
                            </p>
							...
							<tr>
								...
								<td><h4>
                                    <a href="#?id=<?=$res['rem_id'];?>" data-toggle="tooltip" title="Informe de seguimiento"><i class="icon-print"></i></a>
                                </h4></td>
							</tr>
                            <?php $no++;}?>
							</tbody>
