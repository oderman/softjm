						...
						<div class="widget-container">
							<form class="form-horizontal" method="post" action="autentico-documentos.php">
                                ...
                                <div class="control-group">
									<label class="control-label">Clave de acceso a documentos</label>
									<div class="controls">
										<input type="password" class="span4" name="claveDoc" required>
									</div>
								</div>
                                
                               
								<div class="form-actions">
									<button type="submit" class="btn btn-info"> Acceder a documentos</button>
								</div>
							</form>
						</div>
					</div>
						...
						<div class="widget-container">
							...
							<form class="form-horizontal" method="post" action="sql.php">
                                ...
                                <div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" name="claveDoc" value="<?=$datosUsuarioActual['cli_email'];?>" required disabled>
									</div>
								</div>
                                
                               
								<div class="form-actions">
									<button type="submit" class="btn btn-success"> Recordar clave</button>
								</div>
							</form>
						</div>
					</div>
