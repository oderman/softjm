...
$rst_usr = mysqli_query($conexionBdPrincipal,"SELECT * FROM clientes WHERE cli_usuario='".trim($_POST["Usuario"])."' AND cli_clave='".$_POST["Clave"]."' AND TRIM(cli_usuario)!='' AND cli_categoria!='".CLI_CATEGORIA_PROSPECTO."'");
